...
<head>
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <script>
        ...
        // JavaScript function to reset the text when not hovered
        function resetText1(button) {
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto " href="Adminside/index.php">Home</a></li>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              <img src="uploads/<?php echo $_SESSION["adpic"]; ?>" alt="Profile" class="rounded-circle" style="aspect-ratio:1/1;max-width:40px;max-height:40px;object-fit:cover;">
            </a>
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown" style="left: auto; right: 0;"> <!-- Adjust the style here -->
              <li><a class="dropdown-item" href="#"><?php echo $_SESSION["adname"]; ?></a></li>
              <li><a class="dropdown-item" href="#"><?php echo $_SESSION["adrole"]; ?></a></li>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            ...
            <form method="post">
                <div class="approval ">
                    <button class="approval-button" id="button1" name="approve" onmouseover="changeText1(this)" onmouseout="resetText1(this)">APPROVE</button>
                    <button class="approval-button" id="button2" name="reject" onmouseover="changeText2(this)" onmouseout="resetText2(this)">REJECT</button>
                </div>
            </form>
          </div>
